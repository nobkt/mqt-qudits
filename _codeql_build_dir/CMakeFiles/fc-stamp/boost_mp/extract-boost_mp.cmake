...
#
get_filename_component(filename "/home/runner/work/mqt-qudits/mqt-qudits/_codeql_build_dir/_deps/boost_mp-tmp/Boost_1_84_0.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/mqt-qudits/mqt-qudits/_codeql_build_dir/_deps/boost_mp-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-boost_mp${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-boost_mp${i}")
