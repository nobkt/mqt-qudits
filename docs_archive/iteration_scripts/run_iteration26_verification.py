#!/usr/bin/env python3
"""Iteration 26 verification script.

Checks:
- Issue HH fix: QuditGKSLCircuitBosonSimulator._precompute_unitaries now
...
- Regression: All iteration 25 checks (89 checks, Sections 1-15) still pass.
- New: Section 16 adds 6 checks for Issue HH.
...
def main() -> None:
    ...
    out_file = os.path.join(
        out_dir, f"iteration26_hamiltonian_fix_{results['timestamp']}.json"
    )
