...
def main() -> None:
    ...
    # With t_max=100.0 and O(dt) convergence, n_steps=100 (dt=1.0) yields T ≈ 7e-4.
    # The threshold 1e-3 accounts for the t_max scaling of the Stinespring error.
    ...
    print(f"  n_steps=100 trace distance: {t100:.6e} (< 1e-3: {practical_accuracy})")
