...
class MQTGateSequence:
    ...
    def add_r(self, qudit_index: int, level1: int, level2: int,
             theta: float, phi: float = 0.0):
        """Rゲートを追加"""
        self.gates.append({
            'type': 'R',
            'qudit_index': qudit_index,
...
class OptimizedGateBuilder:
    ...
    @staticmethod
    def build_from_2x2_decomposition(params: Dict,
                                     qudit_index: int,
                                     active_indices: List[int]) -> MQTGateSequence:
        """
        2×2分解からゲートシーケンスを構築
    ...
    @staticmethod
    def build_from_3x3_decomposition(params: Dict,
                                     qudit_index: int,
                                     active_indices: List[int]) -> MQTGateSequence:
        """
        3×3分解からゲートシーケンスを構築
