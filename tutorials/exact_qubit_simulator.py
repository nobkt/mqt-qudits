...
class ExactQubitMolecularDynamicsSimulator:
    ...
    def apply_H_transfer_evolution_exact(self, circuit: QuantumCircuit, mol_i: int, mol_j: int, dt: float) -> None:
    ...
    def apply_H_TTA_evolution_exact(self, circuit: QuantumCircuit, mol_i: int, mol_j: int, dt: float) -> None:
