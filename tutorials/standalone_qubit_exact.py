...
class QubitSimulatorExact:
    ...
    def apply_H0_evolution(self, circuit, mol_idx, dt):
    ...
    def apply_H_transfer_exact(self, circuit, mol_i, mol_j, dt):
    ...
    def apply_H_TTA_exact(self, circuit, mol_i, mol_j, dt):
    ...
    def simulate(self, T_total, N_steps):
        ...
        print(f"Qubit Exact Simulation (N={self.N}, T={T_total}fs, steps={N_steps})")
        ...
        print(f"Initial: N_S0={pop_0['N_S0']:.4f}, N_T1={pop_0['N_T1']:.4f}, N_S1={pop_0['N_S1']:.4f}")
        ...
        pop_final = self.calculate_populations(state)
        print(f"Final (t={T_total:.1f}fs): N_S0={pop_final['N_S0']:.6f}, N_T1={pop_final['N_T1']:.6f}, N_S1={pop_final['N_S1']:.6f}")
...
if __name__ == '__main__':
    ...
    print("\nExpected (Classical): N_T1 = 0.7339")
    print(f"Got (Qubit Exact):     N_T1 = {result['N_T1']:.4f}")
    print(f"Difference: {abs(result['N_T1'] - 0.7339):.4f}")
