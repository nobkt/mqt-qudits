...
def apply_H0_evolution_exact(circuit, mol_idx, params, dt):
...
def run_qubit_simulation_exact(params, T_total, N_steps):
    ...
    print("Qubit Statevector Simulation (Exact)")
    ...
    for step in range(1, N_steps + 1):
        ...
        if step == N_steps:
            print(f"  Final (t={t:.1f}fs): N_S0={pop['N_S0']:.6f}, N_T1={pop['N_T1']:.6f}, N_S1={pop['N_S1']:.6f}")
            print(f"  Unphysical: {pop['unphysical']:.6f}")
...
if __name__ == '__main__':
    print("="*70)
    print("Qubit Exact Statevector Validation")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("Compare with expected Classical result:")
    print("  Classical N_T1 at t=100fs: 0.7339")
    final = result['populations'][-1]
    print(f"  Qubit N_T1 at t=100fs:     {final['N_T1']:.4f}")
    print(f"  Difference: {abs(final['N_T1'] - 0.7339):.4f}")
    print("="*70)
